...
| 7 | 어제 개선 product token detail | 64G L-269P1Q 제품 찾아줘 | `pandas_function_cases.component_token_product_lookup`, `match_product_tokens`, `detail_rows` |
...
- 확인 범위: prompt file 4개 한글판, 대표 질문 10개, deterministic reference 계약 6/6, component-level product/function-case 계약 4/4
