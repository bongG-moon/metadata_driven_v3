...
이 metadata는 dataset-neutral하게 유지하세요. main_flow_filters.column_candidates는 넓은 후보 column name만 담습니다. PKG_TYPE1->PKG1, PKG_TYPE1->PKG_TYP1 또는 MCP_NO->MCPSALENO 같은 dataset-specific mapping은 table_catalog.filter_mappings에 넣어야 합니다.
