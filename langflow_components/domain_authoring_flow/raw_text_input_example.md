...
helper의 실제 코드 예시는 MongoDB raw text에 넣지 말고 14 Pandas Prompt Builder의 Specialized Functions 입력 또는 별도 helper package에서 관리해.
```
...
실제 helper 코드는 MongoDB에 저장하지 말고 14 Pandas Prompt Builder의 Specialized Functions 입력에서 관리해.
```
