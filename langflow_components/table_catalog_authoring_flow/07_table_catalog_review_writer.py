...
def _table_doc(item: dict[str, Any]) -> dict[str, Any]:
    ...
    doc = {
        ...
        "namespace": "core",
        "identity": {"type": "table_catalog", "dataset_key": dataset_key},
        "source": {
            "kind": "langflow_authoring_flow",
            "flow": "table_catalog_authoring_flow",
            "component": "07_table_catalog_review_writer",
        },
    ...
    doc["payload_hash"] = _stable_hash({"dataset_key": dataset_key, "payload": payload})
    return doc
